 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class eqCodingGuideline_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (PHP_CodeSniffer::isCamelCaps($varName, false, true, false) === false && preg_match('/^[a-z0-9]$/', $varName) == 0) {
            $error = 'Variable "%s" is not in valid camel caps format';
