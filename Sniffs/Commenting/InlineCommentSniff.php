 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class eqCodingGuideline_Sniffs_Commenting_InlineCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('|[A-Z0-9]|', $commentText[0]) === 0) {
            $error = 'Inline comments must start with a capital letter or a number';
